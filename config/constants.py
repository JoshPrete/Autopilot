...
OWNER_HOURLY_RATE_CENTS = round(
    OWNER_ANNUAL_SALARY_CENTS / (52 * 40)
)  # ~$48.08/hr based on 40hr weeks
...
DEFAULT_ITEM_COSTS = {
    ...
    "long_black": {
        "cost_cents": 90,
        "category": "drink",
        "description": "18g beans + 8oz cup + water",
    },
    "latte": {
        "cost_cents": 140,
        "category": "drink",
        "description": "18g beans + 220ml milk + 12oz cup",
    },
    "cappuccino": {
        "cost_cents": 140,
        "category": "drink",
        "description": "18g beans + 180ml milk + 12oz cup",
    },
    "flat_white": {
        "cost_cents": 120,
        "category": "drink",
        "description": "18g beans + 160ml milk + 8oz cup",
    },
    "mocha": {
        "cost_cents": 170,
        "category": "drink",
        "description": "18g beans + 200ml milk + chocolate + 12oz cup",
    },
    "iced_latte": {
        "cost_cents": 160,
        "category": "drink",
        "description": "18g beans + 200ml milk + ice + 16oz cup",
    },
    "matcha_complex": {
        "cost_cents": 200,
        "category": "drink",
        "description": "matcha powder + 220ml milk + 12oz cup",
    },
    "babycino": {
        "cost_cents": 30,
        "category": "drink",
        "description": "froth + small cup + marshmallow",
    },
    # Food — wholesale cost estimates
    "toastie": {
        "cost_cents": 250,
        "category": "food",
        "description": "bread + ham/cheese + packaging",
    },
    "wrap": {
        "cost_cents": 280,
        "category": "food",
        "description": "tortilla + fillings + packaging",
    },
    "croissant": {
        "cost_cents": 180,
        "category": "food",
        "description": "wholesale bakery + filling",
    },
    ...
    "merchandise": {
        "cost_cents": 800,
        "category": "retail",
        "description": "avg wholesale merch cost",
    },
}
